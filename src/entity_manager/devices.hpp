...
constexpr auto exportTemplates = std::to_array<ExportTemplate>(
    {{"EEPROM_24C01", "24c01 $Address", "/sys/bus/i2c/devices/i2c-$Bus",
     ...
     {"EEPROM_24C512", "24c512 $Address", "/sys/bus/i2c/devices/i2c-$Bus",
      "new_device", "delete_device", createsHWMon::noHWMonDir},
     {"JC42", "jc42 $Address", "/sys/bus/i2c/devices/i2c-$Bus", "new_device",
      "delete_device", createsHWMon::hasHWMonDir},
     {"LTC4287", "ltc4287 $Address", "/sys/bus/i2c/devices/i2c-$Bus",
      "new_device", "delete_device", createsHWMon::hasHWMonDir},
     {"QUANTA_CPLD", "quanta_cg1_cpld $Address",
      "/sys/bus/i2c/devices/i2c-$Bus", "new_device", "delete_device",
      createsHWMon::hasHWMonDir},
     {"SMC_CPLD", "smc_c2_cpld $Address", "/sys/bus/i2c/devices/i2c-$Bus",
      "new_device", "delete_device", createsHWMon::hasHWMonDir},
     {"TCA9539", "tca9539 $Address", "/sys/bus/i2c/devices/i2c-$Bus",
      "new_device", "delete_device", createsHWMon::noHWMonDir}});
} // namespace devices
