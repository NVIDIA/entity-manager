        ...
        {{"EEPROM_24C01",
         ...
         {"TMP75",
          ExportTemplate("tmp75 $Address", "/sys/bus/i2c/devices/i2c-$Bus",
                         "new_device", "delete_device", true)},
         {"TMP75C",
          ExportTemplate("tmp75c $Address", "/sys/bus/i2c/devices/i2c-$Bus",
                         "new_device", "delete_device", true)},
         {"W83773G",
	  ...
	  ExportTemplate("tca9539 $Address", "/sys/bus/i2c/devices/i2c-$Bus",
        ...
        {"QUANTA_CPLD",
          ExportTemplate("quanta_cg1_cpld $Address", "/sys/bus/i2c/devices/i2c-$Bus",
                         "new_device", "delete_device", true)},
        {"ADT7461",
          ExportTemplate("adt7461 $Address", "/sys/bus/i2c/devices/i2c-$Bus",
                         "new_device", "delete_device", true)},
        {"TMP451",
          ExportTemplate("tmp451 $Address", "/sys/bus/i2c/devices/i2c-$Bus",
                         "new_device", "delete_device", true)},
        {"TMP432",
